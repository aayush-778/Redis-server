...
├── Concepts_UseCases.md    # Design concepts and command use cases
├── Makefile                # Build rules
├── README.md               # This documentation
└── test.sh             # Bash script for all tests
```
...
You can connect with the standard `redis-cli`.
...
Refer to [Concepts_UseCases.md](Concepts_UseCases.md) for a detailed description of the underlying concepts (TCP sockets, RESP, data structures, etc.) and real‑world usage scenarios for each command.

---

## Testing

You can verify functionality interactively or via scripts. See the test examples in `Concepts_UseCases.md` or use the provided `test.sh` script for end‑to‑end validation.
